...
- the optional recommendation webhook delivery lane (`push_recommendations_webhook`), including its independent cadence, bounded digest size, and dedupe behavior so unchanged recommendation payloads do not keep re-posting into OpenClaw
