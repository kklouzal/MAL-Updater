...
def _serialize_provider_eligibility_evidence(
    ...
    *,
    ...
    return {
        ...
        "refresh_schedule_version": evidence.refresh_schedule_version,
        "last_successful_positive_at": evidence.last_successful_positive_at,
        ...
        "refresh_due": evidence.refresh_due_at is not None and evidence.refresh_due_at <= current,
        "refresh_overdue": evidence.refresh_due_at is not None and evidence.refresh_due_at < current,
        "refresh_failed": evidence.refresh_status == "failed",
        "last_known_good_preserved": bool(evidence.last_successful_positive_at and not evidence.invalidated_at),
