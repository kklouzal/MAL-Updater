...
class ConfigLoadingTests(unittest.TestCase):
    ...
    def test_defaults_resolve_under_project_root(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(8, config.service.task_hourly_limits["recommend_full_harvest"])
            ...
            self.assertEqual(1, config.service.task_execute_limits["recommend_provider_eligibility_candidates"])
            ...
            self.assertEqual(1, config.service.task_execute_limits["recommend_full_harvest"])
    ...
    def test_settings_example_standard_toml_features_parse_and_preserve_precedence(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(8, parsed["service"]["task_hourly_limits"]["recommend_full_harvest"])
            self.assertEqual(1, parsed["service"]["task_execute_limits"]["recommend_full_harvest"])
